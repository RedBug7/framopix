...
[![Version](https://img.shields.io/badge/Version-1.5-9c88ff?style=for-the-badge)](https://github.com/RedBug7/framopix/releases/latest)
...
### [⬇️ Download Framopix v1.5](https://github.com/RedBug7/framopix/releases/latest)
...
### [⬇️ Download Framopix v1.5 for Windows](https://github.com/RedBug7/framopix/releases/latest)

</div>

1. **Download** Framopix v1.5.zip, extract the folder
...
### v1.5
- Added Report Issue button in the status bar
- Users can report bugs directly from the app
- Opens pre-filled GitHub issue form in browser
